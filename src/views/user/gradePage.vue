...
<template>
  <IonPage>
    ...
    <ion-content :fullscreen="true" class="ion-padding">
      ...
      <ion-grid>
        <ion-row>
          <ion-col size="4" v-for="i in 3" @click="$router.push('/user/gradeDetail/1')">
            <div style="background-color: #F3F5FE;height: 114px;border-radius: 10px;padding-top: 14px">
              <ion-avatar style="display: block;margin: 0 auto 8px auto;width: 35px;height: 35px;"><img src="@/img/小U-02.png" alt=""></ion-avatar>
              <ion-text style="text-align: center;color:#585858;font-size: 12px;display: block;margin: 5px 0">2021-2022学年</ion-text>
              <ion-text style="text-align: center;color:#C0C0E0;font-size: 10px;display: block;margin: 5px 0">详情</ion-text>
            </div>
          </ion-col>
        </ion-row>
      </ion-grid>
