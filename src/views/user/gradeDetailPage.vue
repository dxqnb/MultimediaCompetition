  ...
  <IonPage>
    ...
    <ion-content :fullscreen="true" class="ion-padding">
      ...
      <div style="display:flex;">
        <ion-button style="width: 30%;--background: #6761FD;--color: white;font-size: 13px;min-height: 42px;height: 42px;margin-top: 8px">智能分析&nbsp;<ion-icon :icon="searchOutline"></ion-icon></ion-button>
